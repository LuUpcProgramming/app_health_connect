                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      validator: (value) => TValidator.validateEmptyText('Meta', value),
                          ...
                          child: Container(
                            ...
                            child: Obx(
                              () => DropdownButton<String>(
                                ...
                                onChanged: (newvalue) {
                                  controller.selectedActividad.value = newvalue!;
                                },
                                ...
                                child: Obx(() => GestureDetector(
                                      ...
                                      child: CircleAvatar(
                                        ...
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                            color: controller.isDaySelected(index)
                                                ? Colors.white
                                                : TColors.primary,
                                            fontWeight: FontWeight.bold,
                                          ),
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          ...
                          child: TextFormField(
                            readOnly: true,
                            validator: (value) => TValidator.validateEmptyText('Hora', value),
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            ...
                            child:  const Text('Hora',style: TextStyle(fontSize: 16, color: Colors.white),),
                            onPressed: () async {
                              ...
                              if (picked != null) {
                                controller.selectedPeriodo = picked.period == DayPeriod.am ? 'AM' : 'PM';
                                controller.selectedTime = picked;
                                controller.horaController.text = '${picked.hour}:${controller.addLeadingZero(picked.minute)} ${controller.selectedPeriodo}'    ;
                                controller.selectedHora = '${picked.hour}:${controller.addLeadingZero(picked.minute)}';
                              }
                          }),
                        ),
                      ],
